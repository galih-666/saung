    ...
    ?>
      ...
      <div class="alert alert-orange alert-block">
        <center>
          <h1 class="alert-heading">SELAMAT DATANG</h1> 
           Di Aplikasi Pemesanan Cafe Saung Baraya.
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12">
          <h4///. <img src="saung.jpg" stlye="max-width:100%"> </h4>
        </div>
    </div>
<!--End-Action boxes-->    
  </div>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Cafe Saung Baraya <a href="#">by Muhamad Galih Revanza</a> </div>
</div>
